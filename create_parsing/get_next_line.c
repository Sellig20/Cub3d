...
/*   Updated: 2022/12/20 17:55:21 by jecolmou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	ft_bzero_bb(void *s, size_t n)
// {
// 	int		i;
// 	char	*str;
...
// 		return (0);
// 	}
// 	final = malloc(sizeof(char) * (ft_strlen_bb(str) - i + 1));
// 	if (!final)
// 	{
// 		free(str);
// 		return (0);
